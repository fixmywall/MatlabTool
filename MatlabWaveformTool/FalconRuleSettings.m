function varargout = FalconRuleSettings(varargin)
% FALCONRULESETTINGS MATLAB code for FalconRuleSettings.fig
%      FALCONRULESETTINGS, by itself, creates a new FALCONRULESETTINGS or raises the existing
%      singleton*.
%
%      H = FALCONRULESETTINGS returns the handle to a new FALCONRULESETTINGS or the handle to
%      the existing singleton*.
%
%      FALCONRULESETTINGS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in FALCONRULESETTINGS.M with the given input arguments.
%
%      FALCONRULESETTINGS('Property','Value',...) creates a new FALCONRULESETTINGS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before FalconRuleSettings_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to FalconRuleSettings_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @FalconRuleSettings_OpeningFcn, ...
                   'gui_OutputFcn',  @FalconRuleSettings_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before FalconRuleSettings is made visible.
function FalconRuleSettings_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to FalconRuleSettings (see VARARGIN)
...
% --- Executes on button press in PB_browseFile.
function PB_browseFile_Callback(hObject, eventdata, handles)
% hObject    handle to PB_browseFile (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
[FileName,PathName,FilterIndex] = uigetfile;
handles.EB_filePath.String = PathName;


function EB_filePath_Callback(hObject, eventdata, handles)
% hObject    handle to EB_filePath (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of EB_filePath as text
%        str2double(get(hObject,'String')) returns contents of EB_filePath as a double


% --- Executes during object creation, after setting all properties.
function EB_filePath_CreateFcn(hObject, eventdata, handles)
% hObject    handle to EB_filePath (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
